        ...
        <article className="post">
          ...
          <div itemProp="articleBody" className="post__content">
            ...
            <p>I like tinkering with front-end performance, the latest HTML, CSS and especially JavaScript stuff. To complete the story, I want to mention that I have a degree in application development and in the past used to work in the more enterprise-oriented
              business. Besides that I love dogs, nature, riding motorbikes and enjoy people that take themselves not too seriously.</p>
            ...
            <h2>Colophon</h2>
            <p>This site is built on<a href="http://expressjs.com/"> Express.js</a> and <a href="https://facebook.github.io/react/">React</a> and is the outcome of experimenting with Node.js. Implementation can be found on <a href="https://github.com/jonykrause/jonykrau.se"> Github</a>.</p>
          </div>
        </article>
      </Layout>
    );
