      ...
      <Layout>
        <article className="post">
          ...
          <div itemProp="articleBody" className="post__content">
            ...
            <p>
              I am a passionate web developer, believing in Unix philosophy form- and function-wise. I love effective and fast user interfaces that bring real value to people. I appreciate logical, user-centered design approaches. Therefore I strive to use technologies and
            ...
            <p>Besides that I love nature, <a href="https://www.instagram.com/jonykrause/">riding motorbikes</a> and enjoy people that take themselves not too seriously.</p>
