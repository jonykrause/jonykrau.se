      ...
      <Layout>
        <article className="post">
          ...
          <div itemProp="articleBody" className="post__content">
            ...
            <p>Hey, my name is Jonathan — I would call myself a front-end engineer (you know those job titles). I am currently living in Berlin, Germany, working full-time as a Front-end Engineer at eBay Classifieds Group. I am a passionate
